...
date: 2013-03-06 22:52
comments: true
categories: [debug,eclipse,gdb,kernel,linux,qemu]
---
#单步调试kernel说明
...
![pic1](/images/2013-03-07-1.png)

在进入系统之后，输入uname -a或者uname -r来检验该系统是不是正在运行自己编译内核，看到3.5.4即可。

![pic1](/images/2013-03-07-2.png)
...
![pic1](/images/2013-03-06-1.png)

2. Window -> Preferences -> c/c++ -> Indexer中，将Enable indexer取消
![pic2](/images/2013-03-06-2.png)
